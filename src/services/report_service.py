...
def monthly_report(db, month: str, page: int = 1, page_size: int = 10) -> MonthlyReport:
    vouchers, total_vouchers, total_liters, safe_page = list_vouchers_by_month_paginated(db, month, page, page_size)
