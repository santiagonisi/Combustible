...
function setVoucherRows(items) {
    ...
    items.forEach((voucher) => {
        ...
        tr.innerHTML = `
            ...
            <td style="text-align:center"><button type="button" onclick="window.open('/print/${voucher.id}','_blank')" title="Imprimir" style="margin:0;padding:4px 7px;background:#15803d;border:none;border-radius:8px;cursor:pointer;display:inline-flex;align-items:center;justify-content:center;color:#fff;"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 6 2 18 2 18 9"/><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/><rect x="6" y="14" width="12" height="8"/></svg></button></td>
        `;
